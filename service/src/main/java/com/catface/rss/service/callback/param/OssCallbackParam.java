package com.catface.rss.service.callback.param;
...
/**
 * @author by catface
 * @since 2021/8/24 上午11:01 . All rights reserved.
 */
@Data
@ApiModel(value = "OSS回调请求参数")
public class OssCallbackParam {

    @ApiModelProperty(value = "oss bucket", required = true, example = "xmdev-resource")
    private String bucket;

    @ApiModelProperty(value = "存储在oss的objectName", required = true,
        example = "inst/1090869416918245378/class/456789/20190213183924/nohup.out")
