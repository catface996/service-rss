package com.catface.rss.http.rpc.controller.resource.convert;
...
public class ResourceConvert {
    ...
    private static final BeanCopier CHANGE_RESOURCE_ACCESS_STATUS_REQUEST_2_PARAM = BeanCopier.create(
        ChangeResourceAccessStatusRequest.class, ChangeResourceAccessStatusParam.class, false);
    ...
    public static ChangeResourceAccessStatusParam convert(ChangeResourceAccessStatusRequest request) {
        ChangeResourceAccessStatusParam param = new ChangeResourceAccessStatusParam();
        CHANGE_RESOURCE_ACCESS_STATUS_REQUEST_2_PARAM.copy(request, param, null);
        return param;
    }
